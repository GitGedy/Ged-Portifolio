              ...
              <Box __css={styles} border="none" bg="transparent">
                ...
                <SimpleGrid columns="2" gap="20px">
                  ...
                  <AboutMeInfo
                    boxShadow={cardShadow}
                    title="Education"
                    value="Software Engineering, AAU (On Thersis)"
                  />
                  <AboutMeInfo
                    boxShadow={cardShadow}
                    title="Degree"
                    value="Masters (On Going)"
                  />
                  <AboutMeInfo
                    boxShadow={cardShadow}
                    title="Languages"
        ...
        <Flex justifyContent="center" alignItems="center" mt="20px">
          ...
          >
            <LazyLoadImage
              src={
                colorMode === "light"
                  ? "https://github-readme-streak-stats.herokuapp.com/?user=GitGedy&theme=whatsapp-light&hide_border=true&border_radius=5.8&date_format=j%20M%5B%20Y%5D"
                  : "https://github-readme-streak-stats.herokuapp.com?user=GitGedy&theme=calm-pink&hide_border=true&border_radius=5.8&date_format=j%20M%5B%20Y%5D"
              }
              alt="GitHub Streak"
              effect="blur"
