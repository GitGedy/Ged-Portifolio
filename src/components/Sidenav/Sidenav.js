    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <GitHubButton
              href="https://github.com/GitGedy/Ged-Portifolio"
              data-color-scheme="no-preference: light; light: light; dark: dark_dimmed;"
              data-icon="octicon-star"
              data-size="large"
              aria-label="Star GitGedy/Ged-Portifolio on GitHub"
            >
              Star
            </GitHubButton>

            <GitHubButton
              href="https://github.com/GitGedy/Ged-Portifolio/fork"
              data-color-scheme="no-preference: light; light: light; dark: dark_dimmed;"
              data-icon="octicon-repo-forked"
              data-size="large"
              aria-label="Fork GitGedy/Ged-Portifolio on GitHub"
            >
              Fork
            </GitHubButton>
          </Flex>
